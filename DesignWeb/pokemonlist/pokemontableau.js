...
/********************************************************************/
$('#navpok').click(function () {
    if (navbar===1){
        $('#navpok').attr("src","https://img.icons8.com/color/48/000000/open-pokeball--v1.png");
        navbar=2
    }
    else if (navbar===2){
        $('#navpok').attr("src","https://img.icons8.com/color/48/000000/pokeball-2.png");
        navbar=1
    }
